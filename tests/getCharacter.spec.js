...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    expect(Object.values(getCharacter('Brienne'))).toEqual([
      'Brienne Tarth', 'Knight', ['Im No Lady, Your Grace.', 'I, Brienne Of Tarth, Sentence You To Die.' ] ]);
    ...
    expect(Object.values(getCharacter('aRYa'))).toEqual([ 'Arya Stark', 'Rogue', [ 'Not today', 'A girl has no name.' ] ]);
    expect(getCharacter('Rhaenyra')).toBe(undefined);
  });
});
